...
Ten en cuenta que Vite también resolverá [su archivo de configuración (`vite.config.js`)](/config/#configuring-vite) dentro de la raíz del proyecto, por lo que tendrá que moverlo si se cambia la raíz.
