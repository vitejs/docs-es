...
<template>
  ...
  >
    ...
    <div class="feature__meta">
      <div class="meta__title">Sistema flexible de plugins</div>
      <div class="meta__description">
        Los plugins de Vite amplían la bien diseñada interfaz de plugins de
        Rollup con algunas opciones específicas de Vite adicionales.
      </div>
    </div>
  </div>
</template>
