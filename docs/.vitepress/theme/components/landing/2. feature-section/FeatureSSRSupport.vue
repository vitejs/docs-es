  ...
  >
    <div class="feature__visualization" :class="{ active: isCardActive }">
      ...
      >
        ...
        <text class="client-text" x="236" y="53">Transf. de cliente</text>
        ...
        <text class="server-text" x="236" y="122">Transf. de servidor</text>
    ...
    <div class="feature__meta">
      <div class="meta__title">Soporte SSR de primera clase</div>
      <div class="meta__description">
        Nunca ha sido tan fácil configurar SSR (Renderizado en el lado del
        servidor) personalizado o crear tu propio framework SSR.
      </div>
    </div>
  </div>
</template>
