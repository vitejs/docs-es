...
<template>
  ...
  >
    ...
    <div class="feature__meta meta--center">
      <div class="meta__title">Integración continua del ecosistema</div>
      <div class="meta__description">
        Nuestra integración continua prueba continuamente los cambios de Vite en
        proyectos posteriores, lo que nos permite mejorar Vite con estabilidad y
        confianza.
      </div>
    </div>
  </div>
