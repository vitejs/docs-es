...
<template>
  <div class="sponsor-section">
    ...
    <img
      ...
      loading="lazy"
    />
    <h2>Gratis y de código abierto</h2>
    <h4>
      Vite está bajo licencia MIT y siempre será gratuito y de código abierto.
      Esto es posible gracias a nuestros colaboradores y a estas empresas:
    </h4>
