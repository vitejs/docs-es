  ...
  >
    ...
    >
      ...
      >
        ...
        <h1 class="text-white text-pretty max-w-100">
          La herramienta de compilación para la Web
        </h1>
        <p class="text-white/70 md:text-lg max-w-108 text-pretty">
          Vite es una herramienta de compilación frontend increíblemente rápida
      ...
      <CodeGroup
        :tabs="installTabs"
        class="hidden md:block w-full -mb-4"
        style="
    ...
    <div class="flex flex-col sm:min-h-120">
      <div
