  ...
  <div class="wrapper wrapper--ticks border-t pt-14 sm:pt-30 px-5 sm:px-10">
    ...
    >
      <div class="flex flex-col gap-3">
        <h3 class="text-white max-w-xl text-balance">Amado por la comunidad</h3>
        <p class="max-w-md text-white/70 text-balance">
          No te conformes con nuestra palabra: escucha lo que dicen los miembros
          de la comunidad de Vite.
        </p>
      </div>
      <div
